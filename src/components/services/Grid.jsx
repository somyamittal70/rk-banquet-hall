...
export default function ServiceGrid() {
  ...
  return (
    <section className="relative bg-[#140D08] text-[#F8F6F2] font-poppins py-24 lg:py-36 overflow-hidden">
      {/* Background Architectural Watermark */}
      {/* <div className="absolute right-0 top-1/3 text-[25vw] font-bold font-marcelleus-sc text-white/[0.01] pointer-events-none select-none tracking-widest leading-none">
        SPACE
      </div> */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mb-24 lg:mb-36">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <span className="font-marcelleus-sc text-xs tracking-[0.5em] text-[#C8A96A] uppercase font-bold">
              Our Services
            </span>
          </div>
          <h2 className="font-marcelleus-sc text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-[1.1] tracking-wide">
            Exceptional Venues
            <br />
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-baseline space-x-4 mb-4">
                    <span className="font-marcelleus-sc text-4xl md:text-5xl font-bold text-[#C8A96A]/20">
                      {service.num}
                    </span>
                    <span className="h-[1px] w-12 bg-[#C8A96A]/30" />
                    <span className="font-marcelleus-sc text-xs tracking-[0.3em] text-[#C8A96A] uppercase font-bold">
                      {service.subtitle}
                    </span>
                  </div>

                  {/* Main Title */}
                  <h3 className="font-marcelleus-sc text-2xl sm:text-3xl md:text-4xl font-medium text-white tracking-wide mb-6">
                    {service.title}
                  </h3>
